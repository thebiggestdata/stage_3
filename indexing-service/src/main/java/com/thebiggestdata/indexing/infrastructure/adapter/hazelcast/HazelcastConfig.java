...
public class HazelcastConfig {
    ...
    public HazelcastInstance initHazelcast(String clusterName) {
        ...
        MultiMapConfig invertedIndexConfig = new MultiMapConfig("inverted-index");
        invertedIndexConfig.setBackupCount(2);
        invertedIndexConfig.setAsyncBackupCount(1);
        config.addMultiMapConfig(invertedIndexConfig);

        MapConfig indexedBooksConfig = new MapConfig("indexed-books");
        indexedBooksConfig.setBackupCount(2);
        config.addMapConfig(indexedBooksConfig);
